...
export default function Magwinya() {
  ...
  return (<>
    <TopNav />
    <header className="masthead_Briyanni">
      <div className="container h-100">
        <div className="col-12 text-center">
        <p className="text-center text-light" style={{ position: "relative", top: "140px", fontSize: "23px", }}>Quick & Easy Recipes</p>
          <h1 className="text-center text-light" style={{ position: "relative", top: "25vh", fontSize: "55px", }}>Chicken Briyanni Recipes</h1>
          <p className="text-center text-light" style={{ position: "relative", top: "35vh", fontSize: "25px", }}>You can't go wrong with a Chicken Briyanni. It's a sure way to get the kids clearing their plates, and a winning dinner for two. We've got everything from the classics to fresh new inspiration when you feel like trying something new.</p>

        </div>
      </div>
    </header>
    <h4 className="text-center text-dark my-5" style={{ position: "relative", left: "13%", top: "40px", fontWeight: "600", fontSize: "60px", }}>Chicken Briyanni</h4>
    <div className='text-center' style={{ position: "relative", left: "13%", top: "60px", }}>
      <Image src="images/biryaniChicken.jpg" fluid />;
    </div>
