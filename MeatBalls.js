...
export default function breadForTimes() {
  return (<>
    ...
    <div className="text-center" style={{ position: "relative", left: "7%", top: "10vh", }}>
      <h4 style={{ fontSize: "50px", fontWeight: "600", }}>Delicious Meat Balls</h4>
    </div>
    <img src="images/meatBall2.jpg" style={{ width: "80%", position: "relative", left: "20%", top: "15vh", }} class="img-thumbnail" alt="" fluid />
    ...
    <div className="text" style={{ position: "relative", left: "20%", fontSize: "23px", top: "30vh", }}>
      <p>A meatball is ground meat rolled into a ball, sometimes along with other ingredients, such as bread<br/>
       crumbs, minced onion, eggs, butter, and seasoning.Meatballs are cooked by frying, baking, steaming,<br/>
        or braising in sauce. There are many types of meatballs using different types of meats and spices. </p>
    </div>
